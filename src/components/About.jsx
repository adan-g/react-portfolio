...
const About = () => {
  return (
    <section className='h-[90vh] grid grid-cols-1 lg:grid-cols-8'>
      <div className='lg:col-span-5 flex justify-center items-center'>
        <div 
          className='bg-black12 text-slate-200 border-greenA6 border shadow-md shadow-greenA6 lg:w-4/5 lg:h-2/3 w-11/12 rounded-lg my-10' data-aos='zoom-in' data-aos-duration="1000">
